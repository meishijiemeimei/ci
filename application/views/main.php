        ...
        <div id="nav">
            <ul class="menu">
            	<?foreach ($shopsort2 as $row):?>
                	<li class="level1-li">
                    	<a class="level1-a" href="<?=site_url()?>/blog/index/<?=$row->shop_sort_id2?>/1"><?=$row->shop_sort_title2?></a>
    ...
    <div id="main_container" >
        <div class="main_content">
              ...
              <div class="main_newslist"  >
                  <table borer="0" width="100%" class="main_newslist_list" >
                    <?foreach ($shopsort1 as $row):?>
                      ...
                      <td width="90%">
                      	<a href="<?=site_url()?>/main/index/<?=$row->shop_sort_id1?>/1"><?=$row->shop_sort_title1?></a>
            ...
            <div class="main_center">
              <div class="main_title">
                  <div class="main_titlename">当前类别 ：<?foreach ($nowshopsort as $row):?> <?=$row->shop_sort_title1 ?><?endforeach;?></div>                  
              </div>
